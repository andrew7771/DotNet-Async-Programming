    ...
    public partial class App : Application
    {
        protected override async void OnStartup(StartupEventArgs e)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                {
                    MessageBox.Show("Ensure that StockAnalyzer.Web is running, expecting to be running on https://ps-async.fekberg.com. You can configure the solution to start two projects by right clicking the StockAnalyzer solution in Visual Studio, select properties and then Mutliuple Startup Projects.", "StockAnalyzer.Web IS NOT RUNNING");
                }
            }
        }
    }
